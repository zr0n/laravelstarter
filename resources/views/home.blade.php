...
<body id="page-top" class="index">
    ...
    <nav id="mainNav" class="navbar navbar-default navbar-custom navbar-fixed-top">
        <div class="container">
            ...
            <div class="navbar-header page-scroll">
                ...
                <a class="navbar-brand page-scroll" href="#page-top">{{ config('app.name', 'Laravel') }}</a>
            </div>
    ...
    <header>
        <div class="container">
            <div class="intro-text">
                <div class="intro-heading">{{ $config->home_text }}</div>
                <a href="#services" class="page-scroll btn btn-xl">Mais</a>
            </div>
        </div>
    </header>
            ...
            <div class="row">
                @foreach($gallery as $image)
                  <div class="col-md-4 col-sm-6 portfolio-item">
                      <a href="#portfolioModal" class="portfolio-link" data-toggle="modal" data-description = "{{$image->description}}" data-img= "{{Cloudder::secureShow($image->cloudinary_id, ['width' => 800, 'height' => 800, 'crop' => 'fill'])}}">
                          <div class="portfolio-hover">
                              <div class="portfolio-hover-content">
                                  <i class="fa fa-plus fa-3x"></i>
                              </div>
                          </div>
                          <img src="{{Cloudder::secureShow($image->cloudinary_id, ['width' => 800, 'height' => 800, 'crop' => 'fill'])}}" class="img-responsive" alt="">
                      </a>
            ...
            <div class="row">
                <div class="col-lg-12 text-center">
                    ...
                    <div class="contact-info">
                      <p>Telefone: </p>
                      <h3 class="section-subheading text-muted">{{$config->telephone}}</h3>
                    </div>
                    <div class="contact-info">
                      <p>Celular: </p>
                      <h3 class="section-subheading text-muted">{{$config->cellphone}}</h3>
                    </div>
                </div>
            </div>
            <div class="row">
    ...
    <footer>
        <div class="container">
            <div class="row">
                <div class="col-md-4">
                    <span class="copyright">Copyright &copy; Luiz Fernando 2017</span>
                </div>
                <div class="col-md-4">
                ...
                <div class="col-md-4">
                    Estamos em: <p id="address">{{$config->address}}</p>
                </div>
            </div>
        </div>
    </footer>
                    ...
                    <div class="row">
                        <div class="col-lg-8 col-lg-offset-2">
                            <div class="modal-body">
                                ...
                                <h2 id="modal-description">Project Name</h2>
                                <img id="modal-img" class="img-responsive img-centered" src="" alt="">
